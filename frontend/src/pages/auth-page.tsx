...
// Tabs Context for role selection
const TabsContext = createContext<{
  value: string;
  onValueChange?: (value: string) => void;
}>({ value: "" });
...
export default function AuthPage() {
  ...
  const handleEmailSignup = async () => {
    ...
    if (passwordStrength.value < 50) {
      setFormErrors({ password: "Please create a stronger password" });
      return;
    }
        ...
        <div className="flex flex-col justify-center items-center p-6 lg:p-12 bg-gradient-to-br from-primary/10 via-primary/5 to-background relative lg:flex-1 min-h-[40vh] lg:min-h-screen">
          ...
          <div className="flex flex-col items-center justify-center space-y-10 max-w-2xl mx-auto py-12">
            <div className="text-center space-y-6">
              ...
              <p className="text-xl lg:text-2xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
                Connect, collaborate, and grow with our innovative educational platform
              </p>
            </div>
            ...
            <div className="w-full max-w-lg">
              ...
              <div className="grid grid-cols-2 gap-6">
                {/* Institution logos would go here */}
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-1 flex-col justify-center px-4 py-12 sm:px-6 lg:px-8">
          <div className="mx-auto w-full max-w-md space-y-8">
            <div className="text-center space-y-2">
              ...
              <p className="text-muted-foreground">
                {isSignUp ? "Join our learning community" : "Sign in to continue"}
              </p>
            </div>
              ...
              {!isSignUp ? (
                ...
                <div>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <Button 
                      variant="outline" 
                      className="w-full h-11 font-medium border-2 hover:bg-muted/50" 
                      onClick={handleGoogleLogin} 
                      disabled={loading}
                    >
                      <svg className="mr-2 h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
