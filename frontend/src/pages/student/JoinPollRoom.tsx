...
export default function JoinPollRoom() {
  ...
  const joinRoom = (e: React.FormEvent) => {
    ...
    // Save details to localStorage (can be used later in StudentPollRoom)
    localStorage.setItem("activeRoomCode", roomCode);
    localStorage.setItem("joinedRoom", "true");
    localStorage.setItem("participantName", name);
    localStorage.setItem("description", description);
    localStorage.setItem("accessType", access);
            ...
            <ul className="space-y-2">
              <li>
                <a
                  ...
                  style={{ background: "#e9eef6", color: "#7b61ff" }}
                >
          ...
          >
            ...
            >
              ...
              <form onSubmit={joinRoom} className="space-y-5">
                <div>
                  <label htmlFor="roomCode" className="block font-medium mb-2">
                ...
                <div>
                  <label htmlFor="access" className="block font-medium mb-2">
                    Access Type
                  </label>
                  <select
                    id="access"
